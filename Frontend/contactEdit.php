...
<body id="body">
    ...
    <div id="add_contact_form" class="login-form">
        <form>
            ...
            <!-- Add contact button -->
            <div class="form-group">
                <button type="button" onclick="add_contact()">Edit Contact</button>
            </div>
        ...
        function add_contact() 
        {
            ...
            .then(async (response) => 
            {
                ...
                if (data.success == false) 
                {
                    ...
                    $("#form_result_message").append(`<p>Contact not updated: ${data.error_message}</p>`);
                ...
                else if (data.success == true) 
                {
                    ...
                    if (address_form) 
                    {
                        ...
                        .then(async (response) => 
                        {
                            ...
                            if (data.success == false) 
                            {
                                ...
                                $("#form_result_message").append(`<p>Contact not edited: ${data.error_message}</p>`);
                    ...
                    $("#form_result_message").append("<p>Contact edited successfully</p>");
